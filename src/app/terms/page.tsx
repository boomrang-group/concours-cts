    ...
    <div className="container py-8 md:py-12">
      <Card className="max-w-3xl mx-auto shadow-lg">
        ...
        <CardContent className="space-y-6 prose prose-sm sm:prose-base dark:prose-invert max-w-none">
          <p>Bienvenue sur BantuChamp ! En utilisant notre plateforme, vous acceptez de vous conformer aux présents termes et conditions.</p>
          ...
          <p>BantuChamp se réserve le droit de refuser ou de retirer tout contenu jugé inapproprié ou non conforme aux règles de la compétition.</p>
          ...
          <p>Vous conservez les droits de propriété intellectuelle sur votre contenu soumis. Cependant, vous accordez à BantuChamp une licence non exclusive pour utiliser, reproduire, et afficher votre contenu dans le cadre de la compétition et de sa promotion.</p>
          ...
          <p>BantuChamp se réserve le droit de modifier ces termes à tout moment. Les modifications seront effectives dès leur publication sur le site.</p>
